...
type Timetable struct {
	...
	TeacherID   string             `bson:"teacher_id" json:"teacher_id"`                                                                                      // Required: Reference to the teacher conducting the class
	...
	TimetableID string             `bson:"timetable_id" json:"timetable_id"`
